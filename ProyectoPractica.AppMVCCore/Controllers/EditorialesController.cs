...
namespace ProyectoPractica.AppMVCCore.Controllers
{
    public class EditorialesController : Controller
    {
        ...
        public EditorialesController(ProyectoPracticaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Direccion,Telefono,Email")] Editoriale editoriale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Direccion,Telefono,Email")] Editoriale editoriale)
        {
            if (id != editoriale.Id)
            {
                return NotFound();
