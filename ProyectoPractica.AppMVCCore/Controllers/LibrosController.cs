...
namespace ProyectoPractica.AppMVCCore.Controllers
{
    public class LibrosController : Controller
    {
        ...
        public LibrosController(ProyectoPracticaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Descripcion,Precio,Stock,EditorialId,AutorId,FechaPublicacion")] Libro libro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Descripcion,Precio,Stock,EditorialId,AutorId,FechaPublicacion")] Libro libro)
        {
            if (id != libro.Id)
            {
                return NotFound();
